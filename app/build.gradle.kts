...
android {
    ...
    buildTypes {
        release {
            isMinifyEnabled = false  // Desactivado temporalmente por problemas con R8 y NewPipe
            proguardFiles(
...
dependencies {
    ...
    implementation("com.squareup.retrofit2:converter-gson:2.9.0") // API Instances use Gson
